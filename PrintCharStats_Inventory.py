...
encounterList = [[["You enter the door and see a chest slowly sinking down in lava, you quickly save the chest and open it", "You close the chest and exit the room"], 
        ...
        ["deserter", 3, 7, [["psychic", "poison"], [""], ["physical","fire"]], "A soldier lies in wait for you behin the door, but you manage to evade his first attack. He bears the banner of Mordor all over his tall figure. ", ["The soldier throws a knife at you, hitting you in the foot!", "The soldier slashes at you with his machete!"], "The solder lets out a groan, before falling to the ground motionless"],
