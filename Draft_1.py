...
encounterDictionary = {
    ...
    1: [[''], [''], ['mad_snowman', 4, 3, "En snögubbe står framför dig! Han verkar inte vara glad att se dig.", "Snögubben kastar en snöboll på dig! Det skadar dig inte, men dock så gör kniven han kör in i din arm det.", "Snögubbens huvud och faller till marken, och ingen mer rörelse händer."], ['ice_spirit'], ['frozen_golem']],
